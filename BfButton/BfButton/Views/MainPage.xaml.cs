...
namespace BfButton.Views
{
    public partial class MainPage : ContentPage
    {
        ...
        private double CaptureTimeInSeconds;
        ...
        private void BlueButton_Clicked(object sender, EventArgs e) => Button_Clicked(TeamColor.Blue);
        ...
        private void InitializeScoresFromLogs()
        {
            ...
            CaptureTimeInSeconds = FilesHelper.ReadConfig().timeToCaprure;
        }

        private void ClearButton_Clicked(object sender, EventArgs e)
        {
            if (string.IsNullOrEmpty(DestroyPointEntry.Text))
            {
                return;
            }
            ...
            {
                if (DestroyPointEntry.Text.ToLower() == "settings")
                {
                    StopContest();
